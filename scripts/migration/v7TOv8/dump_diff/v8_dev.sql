...
ALTER TABLE extraschool_activityoccurrence OWNER TO openerp;
...
ALTER TABLE extraschool_activityoccurrence_cild_rel OWNER TO openerp;
...
ALTER TABLE extraschool_activityoccurrence_id_seq OWNER TO openerp;
...
--
-- Name: COLUMN extraschool_child.toto; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_child.toto IS 'toto';
...
ALTER TABLE extraschool_invoice_wizard_schoolimplantation_rel OWNER TO openerp;
...
ALTER TABLE extraschool_one_report OWNER TO openerp;
...
ALTER TABLE extraschool_one_report_day OWNER TO openerp;
...
ALTER TABLE extraschool_one_report_day_child_rel OWNER TO openerp;
...
ALTER TABLE extraschool_one_report_day_id_seq OWNER TO openerp;
...
ALTER TABLE extraschool_one_report_id_seq OWNER TO openerp;
...
ALTER TABLE extraschool_prestation_times_encodage_manuel OWNER TO openerp;
...
ALTER TABLE extraschool_prestation_times_encodage_manuel_id_seq OWNER TO openerp;
...
ALTER TABLE extraschool_prestation_times_manuel OWNER TO openerp;
...
ALTER TABLE extraschool_prestation_times_manuel_id_seq OWNER TO openerp;
...
ALTER TABLE extraschool_prestation_times_of_the_day OWNER TO openerp;
...
ALTER TABLE extraschool_prestation_times_of_the_day_id_seq OWNER TO openerp;
...
--
-- Name: COLUMN extraschool_prestations_wizard.create_uid; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_prestations_wizard.create_uid IS 'Created by';


--
-- Name: COLUMN extraschool_prestations_wizard.create_date; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_prestations_wizard.create_date IS 'Created on';
...
--
-- Name: COLUMN extraschool_prestations_wizard.write_date; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_prestations_wizard.write_date IS 'Last Updated on';


--
-- Name: COLUMN extraschool_prestations_wizard.write_uid; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_prestations_wizard.write_uid IS 'Last Updated by';
...
ALTER TABLE extraschool_prestationscheck_wizard_place_rel OWNER TO openerp;
...
ALTER TABLE extraschool_price_list OWNER TO openerp;
...
ALTER TABLE extraschool_price_list_id_seq OWNER TO openerp;
...
ALTER TABLE extraschool_price_list_version OWNER TO openerp;
...
ALTER TABLE extraschool_price_list_version_id_seq OWNER TO openerp;
...
--
-- Name: COLUMN extraschool_statsone_wizard.create_uid; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_statsone_wizard.create_uid IS 'Created by';


--
-- Name: COLUMN extraschool_statsone_wizard.create_date; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_statsone_wizard.create_date IS 'Created on';
...
--
-- Name: COLUMN extraschool_statsone_wizard.write_uid; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_statsone_wizard.write_uid IS 'Last Updated by';
...
--
-- Name: COLUMN extraschool_statsone_wizard.write_date; Type: COMMENT; Schema: public; Owner: openerp
--

COMMENT ON COLUMN extraschool_statsone_wizard.write_date IS 'Last Updated on';
...
ALTER TABLE extraschool_timecorrection_wizard_place_rel OWNER TO openerp;
...
--
-- Name: extraschool_child_firstname_name_uniq; Type: CONSTRAINT; Schema: public; Owner: openerp; Tablespace: 
--

ALTER TABLE ONLY extraschool_child
    ADD CONSTRAINT extraschool_child_firstname_name_uniq UNIQUE (name, firstname);
...
ALTER TABLE ONLY extraschool_prestations_wizard
    ADD CONSTRAINT extraschool_prestations_wizard_activitycategory_fkey FOREIGN KEY (activitycategory) REFERENCES extraschool_activitycategory(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY extraschool_prestations_wizard
    ADD CONSTRAINT extraschool_prestations_wizard_childid_fkey FOREIGN KEY (childid) REFERENCES extraschool_child(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY extraschool_prestations_wizard
    ADD CONSTRAINT extraschool_prestations_wizard_placeid_fkey FOREIGN KEY (placeid) REFERENCES extraschool_place(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY extraschool_statsone_wizard
    ADD CONSTRAINT extraschool_statsone_wizard_activitycategory_fkey FOREIGN KEY (activitycategory) REFERENCES extraschool_activitycategory(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY extraschool_statsone_wizard
    ADD CONSTRAINT extraschool_statsone_wizard_placeid_fkey FOREIGN KEY (placeid) REFERENCES extraschool_place(id) ON DELETE SET NULL;
