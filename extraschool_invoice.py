...
class extraschool_invoice(models.Model):
    ...
    biller_id = fields.Many2one('extraschool.biller', 'Biller', required=False,ondelete='cascade',readonly=True, index=True)
    ...
    period_from = fields.Date(related='biller_id.period_from', index=True)
    period_to = fields.Date(related='biller_id.period_to', index=True)
