...
Ceci permettra d'insérer son nom, sa fonction et au besoin sa signature dans le document envoyé aux parents.

####################################
Génération d'une attestation fiscale
####################################

Pour générer les attestations fiscales, il faut se rendre dans le Menu "Attestation fiscale".
