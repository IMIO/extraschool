...
Il faut quotidiennement vérifier les erreurs que l'applications ne sait pas résoudre.
Les erreurs sont souvent : une double entrée pour l'enfant, une double sortie pour l'enfant, un scan en dehors des heures des activités définies,...



Pour les résoudre, il suffit de les analyser afin qu'elles soient vérifier.
S'il y a une double entrée ou sortie, vous pouvez, en étant en mode édition / modification, supprimer une ligne d'entrée ou de sortie.
Après cette suppression, il suffit d'appuyer sur le bouton "check", afin de voir si la fiche se met en "Vérifié"
