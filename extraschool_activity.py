...
class extraschool_activity(models.Model):
    ...
    prest_from = fields.Float('From', index = True)
    prest_to = fields.Float('To', index = True)        
    ...
    validity_from = fields.Date('Validity from', index = True)
    validity_to = fields.Date('Validity to', index = True)
