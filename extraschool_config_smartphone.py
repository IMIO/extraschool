...
class extraschool_config_smartphone(models.Model):
    ...
    activitycategories_ids = fields.Many2many('extraschool.activitycategory','extraschool_smartphone_config_activitycategory_rel', 'id', 'activitycategory_id','Activity categories', required=True, default=_get_activity_category_id)
