...
class extraschool_child(models.Model):
    ...
    n_child = fields.Char('N° of child', size=50, track_visibility='onchange')
    n_family = fields.Char('N° of family', size=50, track_visibility='onchange')
    isdisabled = fields.Boolean('Disabled', track_visibility='onchange')
    comment = fields.Text('Comment', track_visibility='onchange')
    comment_plaine = fields.Text('Comment Plaine', track_visibility='onchange')
