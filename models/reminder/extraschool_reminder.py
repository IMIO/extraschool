...
class extraschool_reminder(models.Model):
    ...
    reminders_journal_item_id = fields.Many2one(comodel_name='extraschool.reminders_journal_item',
                                                string='Reminders journal item',
                                                ondelete='cascade', required=False)
    reminders_journal_id = fields.Many2one(comodel_name='extraschool.remindersjournal', string='Reminders journal',
                                           ondelete='cascade',
                                           required=False)
    parentid = fields.Many2one(comodel_name='extraschool.parent', string='Parent', required=False)
    ...
    school_implantation_id = fields.Many2one(comodel_name='extraschool.schoolimplantation',
                                             string='School implantation', required=False)
    concerned_invoice_ids = fields.Many2many(comodel_name='extraschool.invoice',
                                             relation='extraschool_reminder_invoice_rel', column1='reminder_id',
                                             column2='invoice_id', string='Concerned invoices')
