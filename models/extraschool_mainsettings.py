...
class extraschool_mainsettings(models.Model):
    ...
    def reprise_signaletic(self):
        ...
        self.env['extraschool.organising_power'].search([])[0].write({
            'po_name': activity_category.organising_power_id.po_name,
            'po_street': activity_category.organising_power_id.po_street,
            'po_email': activity_category.organising_power_id.po_email,
            'po_zipcode': activity_category.organising_power_id.po_zipcode,
            'po_city': activity_category.organising_power_id.po_city,
            'po_sign': activity_category.organising_power_id.po_sign,
            'po_stamp': activity_category.organising_power_id.po_stamp,
            'po_tel': activity_category.organising_power_id.po_tel,
            'po_addresse_free_text': activity_category.organising_power_id.po_addresse_free_text,
            'po_addresse_free_text2': activity_category.organising_power_id.po_addresse_free_text2,
            'po_resp_name': activity_category.organising_power_id.po_resp_name,
            'po_resp_fct': activity_category.organising_power_id.po_resp_fct,
            'po_sign_img': activity_category.organising_power_id.po_sign_img,
            'po_resp2_name': activity_category.organising_power_id.po_resp2_name,
            'po_resp2_fct': activity_category.organising_power_id.po_resp2_fct,
            'po_resp2_sign': activity_category.organising_power_id.po_resp2_sign,
            'po_rappel_name': activity_category.organising_power_id.po_rappel_name,
            'po_rappel_fct': activity_category.organising_power_id.po_rappel_fct,
            'po_rappel_sign': activity_category.organising_power_id.po_rappel_sign,
            'po_attestation_name': activity_category.organising_power_id.po_attestation_name,
            'po_attestation_fct': activity_category.organising_power_id.po_attestation_fct,
            'po_attestation_sign': activity_category.organising_power_id.po_attestation_sign,
            'logo': activity_category.organising_power_id.logo,
            'slogan': activity_category.organising_power_id.slogan,
            'taxcertificatetemplate': activity_category.organising_power_id.taxcertificatetemplate,
            'max_school_implantation': activity_category.organising_power_id.max_school_implantation,
            'town': activity_category.organising_power_id.po_city,
            'qrcode_report_id': activity_category.organising_power_id.qrcode_report_id.id,
        })
