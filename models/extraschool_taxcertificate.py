...
class extraschool_taxcertificate(models.Model):
    ...
    name = fields.Integer('Fiscal Year', required=True, index=True, track_visibility=True)
...
class extraschool_taxcertificate_item(models.Model):
    ...
    parent_id = fields.Many2one('extraschool.parent',  string ='Parent', required=True, index=True)
    child_id = fields.Many2one('extraschool.child',  string ='Child', required=True, index=True)
...
class extraschool_tax_certificate_detail(models.Model):
    ...
    tax_certificate_item_id = fields.Many2one('extraschool.taxcertificate_item', 'tax_certificate_detail_ids', index=True)
    amount = fields.Float('Amount')
