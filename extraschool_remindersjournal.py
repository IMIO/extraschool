...
class extraschool_remindersjournal(osv.osv):
    ...
    _columns = {
        ...
        'filename': fields.char('File Name', 16, readonly=True),
    ...
    def create(self, cr, uid, vals, *args, **kw):
        ...
        obj_remindersjournal = self.pool.get('extraschool.remindersjournal')
        ...
        cr.execute('select * from extraschool_remindertype where id=%s',(vals['remindertype'],))
        remindertype = cr.dictfetchall()[0]
